...
registerLanguage('en', 'English', {
  ...
  "subtitle": {
    ...
    "segments": "Connections between nodes",
    "lines": "Service lines with color coding and route coverage",
    "modes": "Define types of services",
    "stock": "Rolling stock types and their properties",
    "services": "Route templates defining service paths",
    "schedule": "Generate and manage departures",
    "geomap": "Geographic view of the network",
    "animated": "Live vehicle positions across the network",
  ...
  "csv": {
    ...
    "default_elec": "Default Electrification (rail segments only)",
  ...
  "placeholder": {
    ...
    "eg_waypool": "e.g. 12345, 67890, r4321",
  ...
  "tooltip": {
    ...
    "animate": "Toggle playback controls",
    "anim_now": "Snap to current wall-clock time",
    "anim_speed": "Sim minutes per real second"
  },
  "save_mgr": {
    "title": "Save Manager",
    "col_system": "System",
  ...
  "toast": {
    ...
    "waypool_no_ids": "Enter way or relation IDs for the pool first",
    "waypool_fetching": "Fetching the way pool from OGF...",
    "waypool_fetched": "Way pool cached: {ways} ways",
    "waypool_none": "No usable ways found for the pool",
    "waypool_rel_empty": "No track ways found in relation(s) {ids}",
    "waypool_not_ready": "No way pool cached — fetch it in Settings › OGF first",
    "waypool_cleared": "Way pool cache cleared",
    "waypool_need_latlon": "Both endpoints need OGF coordinates to derive from the pool",
    "waypool_route_fail": "No route through the way pool between {a} and {b}",
    "waypool_from_pool": "Route derived from the way pool: {n} ways, {km} km",
  ...
  "waypool": {
    "warn_no_route": "no route through the pool",
    "warn_no_latlon": "endpoint without OGF coordinates"
  },
  "confirm": {
    "waypool_overwrite": "Re-derive routes for ALL segments from the way pool? Existing way geometry and OGF way lists on every non-interchange segment will be replaced.",
  ...
  "empty": {
    ...
    "no_segments_desc": "Connect nodes with track or road segments.",
  ...
  "issue": {
    ...
    "type": {
      ...
      "schedule_no_run_dates": "Schedule Never Runs",
      "junction_2_connections": "Junction with 2 Connections",
      "suspicious_dwell": "Suspicious Dwell Length"
    },
    "desc": {
      ...
      "schedule_no_run_dates": "Service \"{name}\" has a schedule pattern that never matches any date",
      "junction_2_connections": "Junction \"{name}\" has only 2 connections",
      "suspicious_dwell": "\"{name}\" stops at {station} for {mins} minutes"
    },
    "detail": {
      ...
      "schedule_no_run_dates": "Empty days array with no specific dates (or all are excluded). Add days, specific dates, or set the pattern to daily.",
      "junction_2_connections": "Junctions are for branching points. A 2-connection junction is functionally a waypoint — consider converting it.",
      "suspicious_dwell": "Long mid-route dwells are usually data entry errors. Verify the dwell time on this stop."
    },
  ...
  "settings": {
    ...
    "tab_issues": "Issues",
    "tab_ogf": "OGF",
    "waypool_desc": "The system way pool is the set of OGF ways your network runs on. Enter them once, fetch their geometry once, and every new segment gets its geometry derived from the pool with no further lookups — both endpoints snap onto the pool and the shortest path through it becomes the segment's route.",
    "waypool_ids_hint": "Way IDs, and/or relation IDs prefixed with r (e.g. r4321) to pull in all of a route relation's track ways. Separate with commas, spaces or new lines.",
    "waypool_fetch": "Fetch & cache",
    "waypool_clear": "Clear cache",
    "waypool_status": "{ways} ways cached ({pts} points, {rels} relations) · fetched {when}",
    "waypool_empty": "No pool cached yet — enter IDs and fetch.",
    "waypool_auto": "Derive geometry for new segments from the pool automatically",
